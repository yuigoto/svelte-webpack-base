...
> Projeto inspirado no boilerplate do Svelte e no `create-react-app`, porém sem todo o overhead e convenções do mesmo, ficando apenas com um único `webpack.config.js` para resolver os problemas. Baseado no meu repositório [`webpack-base`](https://github.com/yuigoto/webpack-base).
